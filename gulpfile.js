...
const watcher = done => {
  watch(paths.watch.html).on('change', parallel(tasks.html, browserSync.reload));
  watch(paths.watch.data).on('change', parallel(tasks.html, browserSync.reload));
...
exports.start = series(
  tasks.clean,
  parallel(tasks.php, tasks.images, tasks.css, tasks.fonts, tasks.scripts, tasks.html),
  watcher,
  serve,
);
